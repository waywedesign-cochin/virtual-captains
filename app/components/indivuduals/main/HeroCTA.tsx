      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          >
            <Link
              href={primaryHref}
              className="w-full text-center font-bold text-white tracking-[-0.005em] outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-50 transition-transform hover:scale-102"
